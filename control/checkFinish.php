...
$conn=new db_control();
$conn->db_connect();
$conn->select_db($tableName="bill_info","*",$where="b_customer_id=$u_id and b_status=3" );
...
$query=mysqli_query($c_conn,"select * from bill_info where (b_customer_id=$u_id and b_status=4) or (b_customer_id=$u_id and b_status=0) order by b_id asc limit $startPage,$pageSize");
