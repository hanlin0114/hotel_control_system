...
$result=mysqli_query($c_conn, "select b_rom_id from bill_info where(bill_info.b_r_start_time<'$startDate' and bill_info.b_r_end_time<'$endDate' or bill_info.b_r_start_time>'$startDate' and bill_info.b_r_end_time>'$endDate')");
