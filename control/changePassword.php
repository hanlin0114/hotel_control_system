...
echo "<table class='table table-bordered table-hover definewidth m10' >
    ...
    echo "<th><form action='/hotel_control_system/control/changNick.php' method='post'><input type='text' name='username'/><input type='submit'value='确认'></a>";
    echo "</table></html>";
?>